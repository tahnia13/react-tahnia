                            ...
                            <tbody className="divide-y divide-gray-100">
                                {customers.map((cust) => (
                                    <tr key={cust.id} className="hover:bg-gray-50 transition-colors">
                                        <td className="p-4 text-hijau font-mono font-bold">{cust.id}</td>
                                        ...
                                        <td className="p-4">
                                            <span className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase border ${
                                                cust.loyalty === "Gold" ? "bg-amber-100 text-amber-600 border-amber-200" :
                                                cust.loyalty === "Silver" ? "bg-slate-100 text-slate-600 border-slate-200" :
