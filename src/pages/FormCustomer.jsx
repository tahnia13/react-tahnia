  ...
  return (
    <div id="form-customer-page" className="min-h-screen bg-gray-50">
      <PageHeader
        ...
        breadcrumb={["Dashboard", "Customers", "Register"]}
      />
      ...
      <div className="p-10">
        ...
        >
            ...
            <div>
              ...
              <div className="flex gap-4 mt-2">
                {["Bronze", "Silver", "Gold"].map((tier) => (
                  <label
                    key={tier}
                    className="flex items-center gap-2 cursor-pointer bg-gray-50 px-4 py-2 rounded-lg border hover:border-green-400 transition-all"
                  >
                    <input
                      type="radio"
                      name="loyalty"
                      value={tier}
                      defaultChecked={tier === "Bronze"}
          ...
          <div className="mt-10 flex gap-4">
            <button
              type="submit"
              className="flex-1 bg-hijau text-white px-8 py-4 rounded-xl font-bold hover:bg-emerald-600 shadow-lg shadow-emerald-100 transition-all"
            >
              Daftarkan Customer
            </button>
            <button
